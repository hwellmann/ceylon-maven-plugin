...
public class CeylonRunMojo extends AbstractMojo {
     ...
     * <code>--no-default-repositories</code> option of "ceylon run".
     */
     ...
     */
    @Parameter(property = "ceylon.cwd")
    private String workingDirectory;

    @Parameter(property = "ceylon.mavenOverrides")
     ...
     * <code>--offline</code> option of "ceylon test".
     */
     ...
     * <code>--verbose</code> option of "ceylon run".
     */
    @Parameter(property = "ceylon.verbose")
    private String verbose;

    /**
     * The module to run (without versions).
     */
    @Parameter(property = "ceylon.module")
